...
enum ARCHermesShareDraft {
    static var appGroupIdentifier: String {
        Bundle.main.object(forInfoDictionaryKey: "ARCHermesAppGroupIdentifier") as? String
            ?? "group.com.martinezhermes.archermes"
    }
    ...
    // Keep the v1 content IDs stable for imports staged before the app rename.
    private static let legacyContentIDSalt = "hermex-share-inbox-v1"
    ...
    static var urlScheme: String {
        Bundle.main.object(forInfoDictionaryKey: "ARCHermesURLScheme") as? String
            ?? "hermes-agent"
    }
    ...
    private static func contentID(for sharedImport: SharedImport) -> String {
        var hasher = SHA256()
        update(&hasher, with: Data(legacyContentIDSalt.utf8))
